#ifndef LABA4RKPP_TRUCK_H
#define LABA4RKPP_TRUCK_H
#include <iostream>
#include <string>

using namespace std;

class CompositeTrucks;
...
public:
    ...
    virtual CompositeTrucks* getComposite() { return 0; }

    virtual string getClassType() = 0;
    virtual ~Truck() { --count; }

    virtual double get_loadCapacity() const = 0;
